                    ...
                    <form runat="server" class="needs-validation" novalidate>
                        ...
                        <div class="modal-body">
                          <%--  <div class="mb-3">
                                ...
                                <asp:TextBox ID="UtilisateurID" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1"
                                    ControlToValidate="UtilisateurID" runat="server"
                                    ErrorMessage="Only Numbers allowed"
                                    ValidationExpression="\d+">
                                </asp:RegularExpressionValidator>
                                <div class="invalid-feedback">Veuillez entrer un identifiant d'utilisateur valide.</div>
                            </div>--%>
                            <div class="mb-3">
